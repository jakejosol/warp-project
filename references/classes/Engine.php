...
{	
	...
	{		
		...
		// Authenticate user
		$isAuthenticated = $this->authenticateUser($parameters["username"], $parameters["apiKey"]);
	...
	public static function AddEngine($name, $title, $type, $file)
	{
